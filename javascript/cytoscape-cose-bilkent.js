...
CoSELayout.prototype.classicLayout = function () {
  ...
  //console.log("Classic CoSEs layout finished after " + this.totalIterations + " iterations") chanaka commented 14th may 2019;
  return true;
};
...
Layout.prototype.runLayout = function ()
{
  ...
  else
  {
    ...
    //  console.log("Total execution time: " + excTime + " miliseconds.") chanaka commented 14th may 2019;
    }
  }
...
_CoSELayout.prototype.run = function () {
  ...
  t1.on('message', function (e) {
    ...
    if (logMsg != null) {
     // console.log('Thread log: ' + logMsg); chanaka commented 14th may 2019
      return;
    }
